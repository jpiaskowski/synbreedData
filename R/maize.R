...
#' 
#' This is a simulated dataset of a maize breeding program. Data comprises 1250
#' doubled haploid (DH) lines that were genotyped with 1117 polymorphic SNP
...
#' maize. Pedigree information starts with basis population and is available up
